...
namespace HarmonyLib
{
	...
	internal class InjectedParameter
	{
		...
		internal const string ORIGINAL_PARAM = "__original";
		internal const string PREFIX_SKIPPED_VAR = "__prefixSkipped";
		...
		internal const string LOCAL_STATE_VAR = "__local";
		...
		static readonly Dictionary<string, InjectionType> types = new()
		{
			...
			{ ORIGINAL_PARAM, InjectionType.OriginalMethod },
			...
			{ PREFIX_SKIPPED_VAR, InjectionType.PrefixSkipped },
			{ LOCAL_STATE_VAR, InjectionType.LocalState },
		};
